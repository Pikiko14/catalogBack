 ...
 * create categories
 */
router.post('/', session_middleware_1.default, (0, permission_middleware_1.default)('create-categories'), categories_validator_1.CategoriesCreationValidator, subscription_middleware_1.default, controller.createCategories);
/**
 * list categories
 */
 ...
 * create categories
 */
router.put('/:id', session_middleware_1.default, (0, permission_middleware_1.default)('update-categories'), categories_validator_1.CategoryIdValidator, categories_validator_1.CategoriesCreationValidator, controller.updateCategories);
/**
 * delete categories
 */
